  ...
  const LogoSection = () => (
    <Link href="/" className="flex items-center gap-2 group shrink-0">
      ...
      <div className="flex flex-col">
        <span className="text-xl font-bold tracking-tight text-primary leading-none">חב"ד אזור</span>
        <span className="text-[10px] font-medium text-secondary-foreground tracking-widest uppercase">הבית שלך רחוק מהבית</span>
      </div>
    </Link>
  );
