...
export const WhatsAppButton = ({
  ...
  defaultEmail = "chabadazor1@gmail.com",
  facebookUrl = "https://www.facebook.com/profile.php?id=100064735515777", // Chabad Azor FB page URL
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setSeoTitle(document.title || "בית חב\"ד");
      setSeoDescription(
        document.querySelector('meta[name="description"]')?.getAttribute("content") || 
        "אנחנו כאן בשבילך לכל דבר ביהדות באהבה ובשמחה."
      );
